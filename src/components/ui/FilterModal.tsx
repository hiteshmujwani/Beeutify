              ...
              <View className="flex gap-6 my-4">
                <FilterItem
                  ...
                  setSelected={(service: any) =>
                    setSelected((prev: any) => ({...prev, service: service}))
                  }
                />
                <FilterItem
                  data={Ratings}
                  ...
                  setSelected={(rating: any) =>
                    setSelected((prev: any) => ({...prev, rating: rating}))
                  }
                />
                <FilterItem
                  data={Distance}
                  selected={selected.distance}
                  setSelected={(distance: any) =>
                    setSelected((prev: any) => ({...prev, distance: distance}))
                  }
                />
              </View>
              <Divider className="mx-5 my-3" />
