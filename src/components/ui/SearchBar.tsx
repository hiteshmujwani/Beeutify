...
const SearchBar = ({searchQuery,setSearchQuery,navigation,showModal,setShowModal}:any) => {
  return (
    <>
    <View className="flex-1 !bg-white rounded-xl overflow-hidden">
            ...
            <TouchableOpacity className="bg-white rounded-xl" onPress={()=>{navigation.navigate('Search'),setShowModal && setShowModal(!showModal)}}>
              <FilterIcon />
            </TouchableOpacity>
          </View>
          </>
